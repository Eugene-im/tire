...
g('visarrow').innerHTML=form.circumference.value;
...
//g('buyonline').innerHTML='<a onclick="setCookie(\'buyonline\',\'clicked\',90);" href="/buying-tires-online/">Should I Buy Tires Online? &#8680;</a>';
//    setTimeout(function(){
...
g('byD').innerHTML='<select class="calcbydiameter" onchange="location.href=this.options[this.selectedIndex].value;ga(\'send\', \'event\', \'DiameterLinks\',\'CalcPages\',this.options[this.selectedIndex].text)"><option value="#">Search Tires By Diameter</option><option value="/tiresizes/29-inch-tires/">29 Inch Tires</option><option value="/tiresizes/30-inch-tires/">30 Inch Tires</option><option value="/tiresizes/31-inch-tires/">31 Inch Tires</option><option value="/tiresizes/32-inch-tires/">32 Inch Tires</option><option value="/tiresizes/33-inch-tires/">33 Inch Tires</option><option value="/tiresizes/34-inch-tires/">34 Inch Tires</option><option value="/tiresizes/35-inch-tires/">35 Inch Tires</option><option value="/tiresizes/36-inch-tires/">36 Inch Tires</option><option value="/tiresizes/37-inch-tires/">37 Inch Tires</option><option value="/tiresizes/38-inch-tires/">38 Inch Tires</option><option value="/tiresizes/39-inch-tires/">39 Inch Tires</option><option value="/tiresizes/40-inch-tires/">40 Inch Tires</option><option value="/tiresizes/41-inch-tires/">41 Inch Tires</option><option value="/tiresizes/42-inch-tires/">42 Inch Tires</option><option value="/tiresizes/43-inch-tires/">43 Inch Tires</option><option value="/tiresizes/44-inch-tires/">44 Inch Tires</option><option value="/tiresizes/46-inch-tires/">46 Inch Tires</option><option value="/tiresizes/47-inch-tires/">47 Inch Tires</option><option value="/tiresizes/49-inch-tires/">49 Inch Tires</option><option value="/tiresizes/54-inch-tires/">54 Inch Tires</option></select>';
...
g('visarrow1').innerHTML=form.circumference.value;
...
g('visarrow2').innerHTML=form.circumferenceb.value;
...
g('trywheelcalc').innerHTML="<a onclick=\"ga('send','event','offsetCalcLink','Calc')\" href=\"/wheel-offset-calculator/\">Looking to Compare Wheel Offset?</a>";
...
http2.open("GET", "/includes/sizes.txt", true);
http2.send();
}else{gdTires()}
...
if(tirecalc.sw.value <100){gotolink=gotolink.replace("-","X");var gotosize=gotolink}else{var gotosize=gotolink.replace("-","/")}
g('gotosize').innerHTML="<a onclick=\"ga('send','event','SeeAllTiresLow',gotosize)\" href=\"/tiresizes/"+gotolink+".htm\">Browse "+gotosize+" Tires</a>";
		}
    }
}
}
...
if (http1.status === 404) {g('DisplayTires1').innerHTML="<br><br><div style=\"text-align:center\"><br><b>No Sizes Available<br>Within 3% of Diameter</b></div><br><br>"} else {
g('DisplayTires1').innerHTML=http1.responseText;}
            }
        }
if(g('ShowAlternate').innerHTML=='Alternate Tire Sizes'){
g('ShowAlternate').innerHTML='Alternate Sizes<br>Select to See Available Tires';
g('ShowAlternate').style.cssText='height:35px;text-align:center;font-size:14px;padding:5px 0px 10px 20px;background-image:url(/images/bluearrow.jpg);background-repeat:no-repeat;background-position:25px;line-height:1.4;max-width:300px;margin:0 auto';
    }
  }
}

function sortType(id,type,tirepage,redir){if(type!==undefined){
if(id==15){setCookie('ShowFilters',redir,1);window.location.href=g('getAll').getAttribute("href")}else{
    var notires='';
...
function getVehicle(){g('Vehicle').style.cssText='display:block;background-color:#25292e';g('Xout').innerHTML='<img src="/images/xout.png">';if(window.innerWidth<768){menuClose()}}
...
if(h>100){var h3=Math.round((h*w/100/25.4*2)+r)}else{var h3=h}
if(h>100){var tireheight=Math.round(((h*w/100/25.4*2)+(r))*10*heightratio);}else{var tireheight=h*10*heightratio}
...
if(h>100){var tirewidth=Math.round(h/25.4*10*heightratio*tireratio);}else{var tirewidth=Math.round(w*10*heightratio*tireratio)}

if((isNaN(tireheight))||(w<6)||(h>44 && h<101)||(h<45 && w>16)||(h<21)||(h>100 && w<25)||(r>28)||(r<13)||((h-r)<5)||((h3-r)<5)||(h>375)||(h>100 && w>90)||(h3>44)||((tireheight+tirewidth)>305)){
g('c').innerHTML='<div style="position:absolute;top:45%;left:35%;font-size:8px;text-align:center">Size Not<br>Available<div id="visarrow"></div></div>';
g('tc').innerHTML='<div style="position:absolute;top:45%;left:5%;font-size:8px;text-align:center">Size Not<br>Available</div>';
...
if(g('c').innerHTML.search("Size Not") !== -1){
g('c').innerHTML='<div id="t"><img src="/images/tireview.jpg" alt="Tire Side View"><div id="w"><img src="images/wheelview.png" alt="Wheel Side View"></div></div><div id="a"><img src="/images/circarrow.png" alt=""><div id="visarrow"></div></div>';
g('tc').innerHTML='<img src="/images/talltireview0.jpg" alt="Tire Front View"></div>';
g('visarrow').innerHTML=tirecalc.circumference.value;
}
...
if((isNaN(tireheight))||(w<6)||(h>44 && h<101)||(h<45 && w>16)||(h<21)||(h>100 && w<25)||(r>28)||(r<13)||((h-r)<5)||((h3-r)<5)||(h>375)||(h>100 && w>90)||(h3>44)||((tireheight+tirewidth)>305)){
g('c1').innerHTML='<div style="position:absolute;top:45%;left:35%;font-size:8px;text-align:center">Size Not<br>Available<div id="visarrow1"></div></div>';
g('tc1').innerHTML='<div style="position:absolute;top:45%;left:5%;font-size:8px;text-align:center">Size Not<br>Available</div>';
...
if(g('c1').innerHTML.search("Size Not") !== -1){
g('c1').innerHTML='<div id="t1"><img src="/images/tireview.jpg" alt="Tire 1 Side View"><div id="w1"><img src="images/wheelview.png" alt="Tire 1 Wheel"></div></div><div id="a1"><img src="/images/circarrow1.png" alt=""><div id="visarrow1"></div></div>';
g('tc1').innerHTML='<img src="/images/talltireview1.jpg" alt="Tire 1 Front View">';
g('visarrow1').innerHTML=tirecompare.circumference.value;
}
...
if(h2>100){var h32=Math.round((h2*w2/100/25.4*2)+r2)}else{var h32=h2}
if(h2<100){var size2=h2.toString()+"X"+w2.toString()+"R"+r2.toString();}else{var size2=h2.toString()+"/"+w2.toString()+"R"+r2.toString();}
if(h2>100){var tireheight2=Math.round(((h2*w2/100/25.4*2)+(r2))*10*heightratio2);}else{var tireheight2=h2*10*heightratio2}
...
if(h2>100){var tirewidth2=Math.round(h2/25.4*10*heightratio2*tireratio2);}else{var tirewidth2=Math.round(w2*10*heightratio2*tireratio2)}

if((isNaN(tireheight2))||(w2<6)||(h2>44 && h2<101)||(h2<45 && w2>16)||(h2<21)||(h2>100 && w2<25)||(r2>28)||(r2<13)||((h2-r2)<5)||((h32-r2)<5)||(h2>375)||(h2>100 && w2>90)||(h32>44)||((tireheight2+tirewidth2)>305)){
g('c2').innerHTML='<div style="position:absolute;top:45%;left:35%;font-size:8px;text-align:center">Size Not<br>Available<div id="visarrow2"></div></div>';
g('tc2').innerHTML='<div style="position:absolute;top:45%;left:5%;font-size:8px;text-align:center">Size Not<br>Available</div>';
...
if(g('c2').innerHTML.search("Size Not") !== -1){
g('c2').innerHTML='<div id="t2"><img src="/images/tireview.jpg" alt="Tire 2 Side View"><div id="w2"><img src="images/wheelview.png" alt="Tire 2 Wheel"></div></div><div id="a2"><img src="/images/circarrow2.png" alt=""><div id="visarrow2"></div></div>';
g('tc2').innerHTML='<img src="/images/talltireview2.jpg" alt="Tire 2 Front View">';
g('visarrow2').innerHTML=tirecompare.circumferenceb.value;
}
...
if(flip=="flip"){var diameter=Math.round(parseFloat(c.diameter.value));var height=parseFloat(c.diameter.value);var width=parseFloat(c.width.value);var link=diameter+"-"+wheel+"-"+height+"-mm.htm";getSizes(link,diameter,wheel);}
var dia=Math.round(parseFloat(c.diameter.value)*25.4);if(c.sw.value>100){var wid=c.sw.value}else{var wid=Math.round(parseFloat(c.width.value)*25.4);}
...
g('visheight').innerHTML=dia;g('viswidth').innerHTML=c.sw.value;g('visside').innerHTML=side;g('visarrow').innerHTML=circ;
}
if(co.sw.value !='' && co.swb.value !='' && (co.diameter.value.search('"') >-1)){
var dia1=Math.round(parseFloat(co.diameter.value)*25.4);if(co.sw.value>100){var wid1=co.sw.value}else{var wid1=Math.round(parseFloat(co.width.value)*25.4);}
...
var dia2=Math.round(parseFloat(co.diameterb.value)*25.4);if(co.swb.value>100){var wid2=co.swb.value}else{var wid2=Math.round(parseFloat(co.widthb.value)*25.4);}
...
g('visheight1').innerHTML=dia1;g('viswidth1').innerHTML=wid1;g('visside1').innerHTML=side1;g('visarrow1').innerHTML=circ1;
g('visheight2').innerHTML=dia2;g('viswidth2').innerHTML=wid2;g('visside2').innerHTML=side2;g('visarrow2').innerHTML=circ2;
...
http1.open("GET", "/includes/calcinfo.txt", true);
http1.send();
